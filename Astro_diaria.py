...
for obj in carta_astral.objects:
    ...
    astres.append((obj.id, obj.sign, round(obj.signlon), object.Object.movement(obj), "; ".join(essential.EssentialInfo(obj).getDignities())))
...
print(f"{'Planet':<10}{'Sign':<10}{'°':<5}{'Movement':<15}{'Dignities'}")
print("-" * 60)

# Formatació de cada línia
for planeta, signe, grau, moviment, dignitat in astres:
    print(f"{planeta:<10}{signe:<10}{grau:<5}{moviment:<15}{dignitat}")
print()
# print(aspectes)
